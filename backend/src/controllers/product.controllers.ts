...
import { createProductService, deleteProductService, readAllProductsService, readProductService, updateProductService } from "../services/product.services";
...
export async function deleteProductController(req: Request, res: Response) {
    try {
        ...
        const deletedProductResult = await deleteProductService(id);
